                ...
                <TiltPanel key={group.title} className="rounded-[2rem] p-7">
                  ...
                  >
                    <div className="mb-8 flex items-center justify-between">
                      <div>
                        <p className="font-mono text-xs uppercase tracking-[0.28em] text-white/42">Category</p>
                        <h2 className="mt-2 font-display text-4xl font-bold">{group.title}</h2>
                      </div>
                      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-ice-blue text-2xl text-graphite">
                        <GroupIcon />
                      </div>
                    </div>
                        ...
                        return (
                          <div key={skill.name}>
                            <div className="mb-2 flex items-center justify-between">
                              <span className="flex items-center gap-3 font-semibold text-white/82">
                                <Icon style={{ color: group.accent }} /> {skill.name}
                              </span>
                              <span className="font-mono text-xs text-white/42">{skill.level}%</span>
                            </div>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                custom={index * 0.08}
                viewport={{ once: true }}
                className="rounded-3xl bg-black/20 p-6"
              >
